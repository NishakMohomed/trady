...
<head>
    ...
    <link rel="stylesheet" href="../css/postedAds.css">
</head>
<body>
    <div class="container">
        <table class="content-table">
            ...
            //Finding customer id
            $customerQuery = "SELECT * FROM customer WHERE email = '$customerEmail'";
            $customerResult = mysqli_query($dataBase, $customerQuery);
            $customerRow = mysqli_fetch_array($customerResult);
            $customerId = $customerRow['customer_id'];


            $Query="SELECT * FROM advertisements WHERE customer_id = '$customerId' ORDER BY ad_id ASC";
        ...
        <div class="modal-content">
            ...
            <div class="update_section">
                <div class="update_form_content">
                    ...
                    <form method="POST" action="postedAds.php">
     ...
     <div class="deleteConfirmation">
        <div class="modal-content">
            ...
            <div class="update_section">
                <div class="update_form_content">
                    <h2>Delete</h2>
                    <form action="postedAds.php" method="POST">
                        <div class="update_input">
